local hls = function(colors, opts)
	return {
		...
		["@comment"] = { fg = colors.base03, italic = opts.italics },
		["@conditional"] = { fg = colors.base0E },
		["@constant"] = { fg = colors.base09 },
		["@constant.builtin"] = { fg = colors.base09, italic = opts.italics },
		...
		["@function.builtin"] = { fg = colors.base0D, italic = opts.italics },
		...
		["@text.emphasis"] = { fg = colors.base09, italic = opts.italics },
